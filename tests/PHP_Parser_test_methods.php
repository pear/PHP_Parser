...
class PHP_Parser_test_methods extends PHPUnit_TestCase
{
    /**
    ...
    function PHP_Parser_test_methods($name)
    {
...
EOF;
    ...
    function test_valid_methods_params3()
    {
        if (!$this->_methodExists('setParser')) {
            return;
        }
...
EOF;
    ...
    function test_valid_methods_params4()
    {
        if (!$this->_methodExists('setParser')) {
            return;
        }
...
EOF;
    ...
    function test_valid_referencedVars()
    {
        if (!$this->_methodExists('setParser')) {
            return;
        }
...
EOF1',
                ...
                'interfaces' => array(),
                'includes' => array(
                    array('file' => '"hi"', 'type' => 'include', 'startline' => 5, 'endline' => 5, 'documentation' => ''),
                    array('file' => '"hi"', 'type' => 'include_once', 'startline' => 6, 'endline' => 6, 'documentation' => ''),
                    array('file' => '"hi"', 'type' => 'require', 'startline' => 7, 'endline' => 7, 'documentation' => ''),
                    array('file' => '"hi"', 'type' => 'require_once', 'startline' => 8, 'endline' => 8, 'documentation' => ''),
                    ),
                'functions' => array(),
                'constants' => array(),
                'globals' => array(),
