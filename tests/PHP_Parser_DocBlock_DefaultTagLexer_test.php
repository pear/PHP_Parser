...
class PHP_Parser_DocBlock_DefaultTagLexer_test extends PHPUnit_TestCase
{
    /**
     * A PHP_Parser_DocBlock_DefaultTagLexer object (or one of the drivers)
     * @var        object
     */
    var $lexer;
    /**
    ...
    function PHP_Parser_DocBlock_DefaultTagLexer_test($name)
    {
    ...
    function setUp()
    {
        ...
        $this->lexer = new PHP_Parser_DocBlock_DefaultTagLexer;
